...
namespace PsiStoreTool
{
    ...
    public class Program
    {
        ...
        private static int Main(string[] args)
        {
            ...
            try
            {
                return Parser.Default.ParseArguments<Verbs.ListStreams, Verbs.Info, Verbs.RemoveStream, Verbs.IsolateStream, Verbs.Messages, Verbs.Save, Verbs.Send, Verbs.Concat, Verbs.Crop, Verbs.ListTasks, Verbs.Exec>(args)
                    .MapResult(
