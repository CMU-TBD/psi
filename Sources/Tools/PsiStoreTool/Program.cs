...
namespace PsiStoreTool
{
    ...
    public class Program
    {
        ...
        private static int Main(string[] args)
        {
            ...
            try
            {
                return Parser.Default.ParseArguments<Verbs.ListStreams, Verbs.Info, Verbs.RemoveStream, Verbs.IsolateStream, Verbs.Messages, Verbs.Save, Verbs.Send, Verbs.Concat, Verbs.Crop, Verbs.Encode, Verbs.ListTasks, Verbs.Exec>(args)
                    .MapResult(
                        ...
                        (Verbs.IsolateStream opts) => Utility.IsolateStream(opts.Stream, opts.Store, opts.Path),
