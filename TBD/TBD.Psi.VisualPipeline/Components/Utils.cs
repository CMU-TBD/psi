...
namespace TBD.Psi.VisualPipeline.Components
{
    ...
    internal class Utils
    {
        ...
        internal static (double, double) CalculateDifference(CoordinateSystem cs1, CoordinateSystem cs2)
        {
            ...
            var quaternion1 = VisualPipeline.Utils.GetQuaternionFromCoordinateSystem(cs1);
            var quaternion2 = VisualPipeline.Utils.GetQuaternionFromCoordinateSystem(cs2);
