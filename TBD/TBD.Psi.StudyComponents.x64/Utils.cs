...
namespace TBD.Psi.StudyComponents
{
    ...
    public class Utils
    {
        ...
        public Quaternionf GetQuaternionfFromCoordinateSystem(CoordinateSystem cs)
        {
            var rotMat = cs.GetRotationSubMatrix();
            double trace = rotMat.At(0, 0) + rotMat.At(1, 1) + rotMat.At(2, 2);
            double w, x, y, z;
        ...
        public Frame3f FromCoordinateSystem(CoordinateSystem cs)
        {
            return new Frame3f(new Vector3f(cs.Origin.X, cs.Origin.Y, cs.Origin.Z), GetQuaternionfFromCoordinateSystem(cs));
        }
